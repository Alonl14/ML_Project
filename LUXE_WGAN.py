...
QT = qt(output_distribution='normal',n_quantiles=30000,subsample=1000000)
#data_path = '/Users/alonlevi/PycharmProjects/ML_Project/Full_Sim_55M.csv' ### this is for local running
data_path = '/storage/agrp/alonle/GAN_InputSample/Full_Sim_55M.csv' ### this is from WIS cluster
